...
| Birthday          | date         |      3       |          3           |
| Gender            | char         |      1       |          1           |
| Email             | varchar(40)  |      40      |          25          |
| Phone_number      | varchar(40)  |      40      |          12          | 
| About             | varchar(1000)|      1000    |          100         |
| Icon_id           | int64        |      8       |          8           |
| **Сумма**         | -            |   **1210**   |          **192**     |

Размер одной записи - около 192 байт.

При размере аудитории в 75 млн пользователей получим общий объём таблицы: 13.4 Гб
