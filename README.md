...
- Северная Америка - 1 ДЦ (Соединенные Штатах)
- Южная Америка - 1 ДЦ (Бразилия)
- Европа - 1 ДЦ (Франция)
- Азия - 1 ДЦ (Индия)
- Австралия - 1 ДЦ  
  
США, Бразилия и Индия были выбраны, поскольку они имеют наибольшее количество пользователей среди стран на своих частях света. В Европе наибольшее количество пользователей имеют Польша и Испания, но также примерно такое же количество пользователей имеют Франция, Великобритания и Германия, поэтому наиболее эффективным решением будет расположение датацентра во Франции.
